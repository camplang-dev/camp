...
public sealed class SyntaxHighlightingFilesTests
{
	...
	public void Syntax_files_highlight_test_attributes_and_support_calls_without_reserved_keywords()
	{
		...
		Assert.Contains("@(test|testonly|skip|factorytest|testname)", micro, StringComparison.Ordinal);
		...
		Assert.Contains("@(?:test|testonly|skip|factorytest|testname)", sublime, StringComparison.Ordinal);
		...
		Assert.Contains("@(?:test|testonly|skip|factorytest|testname)", vscode, StringComparison.Ordinal);
		...
		Assert.Contains("syntax keyword campTestAttribute test testonly skip factorytest testname", vimSyntax, StringComparison.Ordinal);
		Assert.Contains("stackalloc", vimSyntax, StringComparison.Ordinal);
		Assert.Contains(" prep ", vimSyntax, StringComparison.Ordinal);
