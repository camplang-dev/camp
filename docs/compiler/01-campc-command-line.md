...
| `--requires` | Add a module-level configuration requirement expression. |
| `--explicit-requires` | Require library-style explicit availability requirements for ambient true capability use. |
| `--implicit-requires` | Allow executable-style implicit ambient requirements. |
